...
target.genes <- read.table(file="../tablas/repressed_genes_35SCO_wt_14d.txt")
...
#write.table(go.result.table, file = "go_terms_table_repressed_35sco-wt.txt", sep = "\t", row.names = F, quote = F)
...
png(filename = 'barplot_repressed_35sco_wt_14days.png', width =8, height = 5,units = 'in',res = 300)
