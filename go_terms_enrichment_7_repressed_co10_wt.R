...
target.genes <- read.table(file="../tablas/repressed_genes_co10_wt_7d.txt")
...
png(filename = 'barplot_repressed_co10_wt_7days.png', width =8, height = 5,units = 'in',res = 300)
...
png(filename = 'treemap_repressed_co10_wt_7days.png', width =20, height = 10,units = 'in',res = 300)
treemapPlot(reducedTerms)
