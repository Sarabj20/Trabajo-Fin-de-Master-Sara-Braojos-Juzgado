...
counts <- read.table(file="counts7.txt", sep = "\t", header = T)
...
#write.table(sample.counts, file = "sample_counts_7.txt", sep = "\t", quote = FALSE)
...
# In this case is not necessary to perform any batch correction
...
#png(filename = 'voom_mean_variance_trend_7d.png', width =10, height = 7,units = 'in',res = 300)
#y <- voom(d, mm, plot = T)
#dev.off()
...
#png(filename = 'boxplot_no_normalized_data_7days.png', width =10, height = 7,units = 'in',res = 300)
...
#png(filename = 'boxplot_normalized_data_7days.png', width =10, height = 7,units = 'in',res = 300)
...
head(x35SCO.wt)
#write.table(x35SCO.wt, file = "tablas/contraste_35sco_wt_7.txt", sep = "\t", quote = FALSE) #Para gráfico expresión FC de los genes
...
# write.table(activated.genes.35SCO, file="tablas/activated_genes_35SCO_wt_7d.txt", sep="\n", quote = FALSE, col.names = FALSE, row.names = FALSE)
# write.table(repressed.genes.35SCO, file="tablas/repressed_genes_35SCO_wt_7d.txt", sep="\n", quote = FALSE, col.names = FALSE, row.names = FALSE)

x35SCO.wt.activated.info <- x35SCO.wt[activated.genes.35SCO,]
x35SCO.wt.repressed.info <- x35SCO.wt[repressed.genes.35SCO,]

# write.table(x35SCO.wt.activated.info, file="tablas/x35SCO_wt_activated_info_7d.txt", sep="\t", quote = FALSE, col.names = TRUE, row.names = TRUE)
# write.table(x35SCO.wt.repressed.info, file="tablas/x35SCO_wt_repressed_info_7d.txt", sep="\t", quote = FALSE, col.names = TRUE, row.names = TRUE)
...
head(co10.wt)
#write.table(co10.wt, file = "tablas/contraste_co10_wt_7.txt", sep = "\t", quote = FALSE) #Para gráfico expresión FC de los genes
...
# write.table(activated.genes.co10, file="tablas/activated_genes_co10_wt_7d.txt", sep="\n", quote = FALSE, col.names = FALSE, row.names = FALSE)
# write.table(repressed.genes.co10, file="tablas/repressed_genes_co10_wt_7d.txt", sep="\n", quote = FALSE, col.names = FALSE, row.names = FALSE)

co10.wt.activated.info <- co10.wt[activated.genes.co10,]
co10.wt.repressed.info <- co10.wt[repressed.genes.co10,]

# write.table(co10.wt.activated.info, file="tablas/co10_wt_activated_info_7d.txt", sep="\t", quote = FALSE, col.names = TRUE, row.names = TRUE)
# write.table(co10.wt.repressed.info, file="tablas/co10_wt_repressed_info_7d.txt", sep="\t", quote = FALSE, col.names = TRUE, row.names = TRUE)
...
png(filename = 'volcanoplot_35sco_wt_7d.png', width =7, height = 5,units = 'in',res = 300)
...
png(filename = 'volcanoplot_co10_wt_7d.png', width =7, height = 5,units = 'in',res = 300)
