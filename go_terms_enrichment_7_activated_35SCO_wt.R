...
target.genes <- read.table(file="../tablas/activated_genes_35SCO_wt_7d.txt")
...
png(filename = 'barplot_activated_35sco_wt_7days.png', width =8, height = 5,units = 'in',res = 300)
...
png(filename = 'treemap_activated_35sco_wt_7days.png', width =20, height = 10,units = 'in',res = 300)
